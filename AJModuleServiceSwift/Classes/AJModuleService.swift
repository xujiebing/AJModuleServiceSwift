...
open class AJModuleService: NSObject, UIApplicationDelegate {
    ...
    open func applicationDidFinishLaunching(_ application: UIApplication, _ launchOptions: [UIApplication.LaunchOptionsKey : Any]?) {
        
    }
    
    open func supportedInterfaceOrientations(_ application: UIApplication, _ className: String) -> (Bool, UIInterfaceOrientationMask) {
        return (false, .all)
    }
